<template>
  <div v-if="asideSecondaryDisplay" class="aside-secondary d-flex flex-row-fluid">
                      ...
                      <div data-kt-search-element="wrapper">
                        <div data-kt-search-element="results" class="d-none">
                          <div class="scroll-y mh-200px mh-lg-350px">
                            ...
                            <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                              <div class="symbol symbol-40px me-4">
                                <img :src="getAssetPath('media/avatars/300-14.jpg')
    " alt="" />
                              </div>
                            ...
                            <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                              <div class="symbol symbol-40px me-4">
                                <img :src="getAssetPath('media/avatars/300-11.jpg')
    " alt="" />
                              </div>
                            ...
                            <a href="#" class="d-flex text-gray-900 text-hover-primary align-items-center mb-5">
                              <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                  <img class="w-20px h-20px" :src="getAssetPath(
    ...
    " alt="" />
                        ...
                        <div class="mb-4" data-kt-search-element="main">
                          ...
                          <div class="scroll-y mh-200px mh-lg-325px">
                            ...
                            <div class="d-flex align-items-center mb-5">
                              <div class="symbol symbol-40px me-4">
                                <span class="symbol-label bg-light">
                                  <KTIcon icon-name="chart-simple-2" icon-class="fs-2 text-primary" />
                                </span>
                              </div>
                      ...
                      <form data-kt-search-element="advanced-options-form" class="pt-1 d-none">
                        <h3 class="fw-semobold text-gray-900 mb-7">
                          Advanced Search
                        </h3>
                    ...
                    <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                      <div class="symbol symbol-40px me-5">
                        <span class="symbol-label">
                          <img :src="getAssetPath('media/svg/brand-logos/bebo.svg')
    " class="h-50 align-self-center" alt="" />
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <!-- <span class="text-gray-500 fw-semibold">By James</span> -->
                      </div>
                    </a>
                    ...
                    <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                      <div class="symbol symbol-40px me-5">
                        <span class="symbol-label">
                          <img :src="getAssetPath('media/svg/brand-logos/vimeo.svg')
    " class="h-50 align-self-center" alt="" />
                        </span>
                      </div>
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <!-- <span class="text-gray-500 fw-semibold">By Andres</span> -->
                      </div>
                    </a>
    ...
    " class="h-50 align-self-center" alt="" />
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <!-- <span class="text-gray-500 fw-semibold">By Keenthemes</span> -->
                      </div>
                    </a>
                    ...
                    <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                      <div class="symbol symbol-40px me-5">
                        <span class="symbol-label">
                          <img :src="getAssetPath('media/svg/brand-logos/balloon.svg')
    " class="h-50 align-self-center" alt="" />
                        </span>
                      </div>
                      ...
                      <div class="d-flex flex-column flex-grow-1">
                        ...
                        <!-- <span class="text-gray-500 fw-semibold">By SIA Team</span> -->
                      </div>
                    </a>
                  </div>
                </div>
            ...
            <div class="tab-pane fade" id="kt_aside_nav_tab_sms" role="tabpanel">
              <div class="m-0">
                

                <div class="m-0">
                  <h1 class="text-gray-800 fw-semibold mb-6 mx-5">SMS</h1>
    ...
    " class="h-50 align-self-center" alt="" />
            ...
            <div class="tab-pane fade" id="kt_aside_nav_tab_email" role="tabpanel">
              <div class="m-0">
             

                <div class="m-0">
                  <h1 class="text-gray-800 fw-semibold mb-6 mx-5">Email</h1>
    ...
    " class="h-50 align-self-center" alt="" />
            ...
            <div class="tab-pane fade" id="kt_aside_nav_tab_feedback" role="tabpanel">
              <div class="m-0">
              

                <div class="m-0">
                  <h1 class="text-gray-800 fw-semibold mb-6 mx-5">FeedBack</h1>
    ...
    " class="h-50 align-self-center" alt="" />
                  ...
                  <router-link to="/terminalquestions">
                    <a href="#" class="custom-list d-flex align-items-center px-5 py-4">
                      <div class="symbol symbol-40px me-5">
                        <span class="symbol-label">
                          <img :src="getAssetPath(
    ...
    " class="h-50 align-self-center" alt="" />
            ...
            <div class="tab-pane fade" id="kt_aside_nav_tab_loyalty" role="tabpanel">
              <div class="m-0">
               

                <div class="m-0">
                  <h1 class="text-gray-800 fw-semibold mb-6 mx-5">Loyalty</h1>
    ...
    " class="h-50 align-self-center" alt="" />
            ...
            <div class="tab-pane fade" id="kt_aside_nav_tab_branch" role="tabpanel">
              <div class="m-0">
              
              
                <div class="m-0">
                  <router-link to="/branches">
                  <h1 class="text-gray-800 fw-semibold mb-6 mx-5">Branches</h1>
                </router-link>
              
                </div>
              </div>
            </div>
            <div class="tab-pane fade" id="kt_aside_nav_tab_tenants" role="tabpanel">
              <div class="m-0">
               

                <div class="m-0">
                  <router-link to="/tenants">
                  <h1 class="text-gray-800 fw-semibold mb-6 mx-5">Tenants</h1>
                </router-link>
              </div>   
            </div>
          </div>
            ...
            <div class="tab-pane fade" id="kt_aside_nav_tab_subscription" role="tabpanel">
              ...
              <div class="mx-5">
                ...
                <div class="text-center pt-10 mb-20">
                  <!--begin::Title-->
                  <h2 class="fs-2 fw-bold mb-7">My Subscriptmnmnmnmnion</h2>
                  <!--end::Title-->
                ...
                <div class="text-center px-4">
                  <img class="mw-100 mh-300px" alt="" :src="getIllustrationsPath('18.png')" />
                </div>
                <!--end::Illustration-->
              </div>
              <!--end::Subscription-->
  ...
  <button v-if="asideSecondaryDisplay && minimizationEnabled" :class="{ active: minimizedAsideSecondary }"
